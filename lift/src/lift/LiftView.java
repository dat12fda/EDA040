...
class PersonDrawer {
	...
	public static void draw(Graphics g,int x,int y) {
		...
		g.drawLine(x+12,y-28,x+12,y-55);
//		g.drawOval(x+10,y-26,2,2);
//		g.drawOval(x+12,y-26,2,2);
		g.drawLine(x+12,y-55,x,y-35);
		g.drawLine(x+12,y-55,x+24,y-35);
		g.drawLine(x+8,y-75,x+11,y-73);
		g.drawOval(x+5,y-72,5,5);
		g.drawLine(x+14,y-73,x+17,y-75);
		g.drawOval(x+15,y-72,5,5);
		g.drawRect(x, y-79, 25, 25);
		g.drawRect(x+7, y-62, 15, 5);
	}
