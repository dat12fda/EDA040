...
public class WashingProgram2 extends WashingProgram {
	...
	protected void wash() throws InterruptedException {
		...
		System.out.println("Starting program2");
		//pre-wash
		...
		tc.putEvent(new TemperatureEvent(this, TemperatureEvent.TEMP_SET, 40.0));
		mailbox.doFetch();
		sc.putEvent(new SpinEvent(this, SpinEvent.SPIN_SLOW));
		sleep((long)(500 * 1000 / mySpeed));   // CHANGE TO 30 MIN
		System.out.println("Done with pre-wash");
		/* SUPPOSED TO DRAIN AND REFILL?? */
		/* SUPPSED TO STOP THE SPIN WHILE HEATING FROM 40 TO 90 ? */
		//main wash
		tc.putEvent(new TemperatureEvent(this, TemperatureEvent.TEMP_SET, 90.0));
		mailbox.doFetch();
		sc.putEvent(new SpinEvent(this, SpinEvent.SPIN_SLOW));
		sleep((long)(500 * 1000 / mySpeed));   // CHANGE TO 30 MIN
